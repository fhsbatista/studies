  ...
  describe "initialization" do
    ...
    describe "task string parsing" do
      it "handles an empty string" do
        creator = CreateProject.new(name: "Project Runway", task_string: "")
        tasks = creator.convert_string_to_tasks
        expect(tasks).to be_empty
      end

      it "handles a single string" do
        creator = CreateProject.new(name: "Project Runway", task_string: "Start Things")
        tasks = creator.convert_string_to_tasks
      ...
      it "handles a single string with size" do
        creator = CreateProject.new(name: "Project Runway", task_string: "Start Things:3")
        tasks = creator.convert_string_to_tasks
        expect(tasks.size).to eq(1)
      ...
      it "handles a single string with size zero" do
        creator = CreateProject.new(name: "Project Runway", task_string: "Start Things:0")
        tasks = creator.convert_string_to_tasks
        expect(tasks.size).to eq(1)
        expect(tasks.first).to have_attributes(title: "Start Things", size: 1)
      end
      ...
      it "attaches tasks do the project" do
        creator = CreateProject.new(name: "Project Runway", task_string: "Start Things:3\nEnd Things:2")
        creator.create
