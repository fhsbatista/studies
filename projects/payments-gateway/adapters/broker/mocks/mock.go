...
// Source: adapters/broker/interface.go
...
func (m *MockProducerInterface) Publish(msg interface{}, key []byte, topics string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Publish", msg, key, topics)
	ret0, _ := ret[0].(error)
	return ret0
}

// Publish indicates an expected call of Publish.
func (mr *MockProducerInterfaceMockRecorder) Publish(msg, key, topics interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Publish", reflect.TypeOf((*MockProducerInterface)(nil).Publish), msg, key, topics)
}
